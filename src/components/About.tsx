...
export function About({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="about-section" id="network">
      <div className="network-visual" aria-hidden="true"><span>MISO JAPAN</span><strong>01</strong><small>ACCOUNTABLE<br />PARTNER</small></div>
      <div className="about-copy">
        <p className="eyebrow">{locale === "vi" ? "Vì sao là Việt Nam, vì sao là MISO JAPAN" : "Why Vietnam, why MISO JAPAN"}</p>
